        ...
        return [
            ...
            'assistant' => [
                ...
                'description' => sprintf(
                    ...
                    __('Override the modelfile and create a custom assistant. Applies to %s Chat generations and shortcodes.', 'alpaca-bot'),
                    '<a href="' . esc_url(admin_url('admin.php?page=alpaca-bot&mode=generate')) . '">Single-turn</a>'
                ),
            ],
            'parameters' => [
