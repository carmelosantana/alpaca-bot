...
namespace CarmeloSantana\OllamaPress\Editor;
...
class Screen
{
    ...
    {
        // add submenu page for Editor, loading Editor.php
        add_submenu_page(
            'ollama-press',
            'Editor',
            'Editor',
    ...
    public function renderAdminPage()
    {
        if (is_multisite() && !is_network_admin()) {
            wp_redirect(network_admin_url('admin.php?page=ollama-press-editor'));
            exit;
        }
            ...
            if (is_wp_error($r)) {
                ...
                wp_redirect(
                    add_query_arg(
                        ...
                        admin_url('admin.php?page=ollama-press-editor')
                    )
                );
                exit;
            }
	...
	<pre>' . $error_code . '</pre>';
            ...
            <div class="fileedit-sub">
                ...
                <div class="alignright">
                    <form action="admin.php?page=ollama-press-editor" method="get">
                    ...
                    <?php if ($theme->parent()) : ?>
                        <li class="howto">
                            ...
                            printf(
                                ...
                                sprintf(
                                    '<a href="%s">%s</a>',
                                    self_admin_url('admin.php?page=ollama-press-editor&theme=' . urlencode($theme->get_template())),
            ...
            ?>
                <form name="template" id="template" action="admin.php?page=ollama-press-editor" method="post">
        ...
        if (!in_array('theme_editor_notice', $dismissed_pointers, true)) {
            ...
            $excluded_referer_basenames = array('admin.php?page=ollama-press-editor', 'wp-login.php');
